...
authors = [
    { 'name': 'Abhijeet Kandalkar', 'email': 'abhijeet.k|sam-----sung\O/com' },
    { 'name': 'Ajay Berwal', 'email': 'ajay.berwal|sam-----sung\O/com' },
    { 'name': 'Akhil Teeka Dhananjaya', 'email': 'akhil.td|sam-----sung\O/com' },
    { 'name': 'Behara Mani Shyam Patro', 'email': 'behara.ms|sam-----sung\O/com' },
    { 'name': 'Gandhi Kishor Addanki', 'email': 'kishor.ag|sam-----sung\O/com' },
    { 'name': 'Ganesh Kamat', 'email': 'ganesh.kamat|sam-----sung\O/com' },
    { 'name': 'Kaja Mohaideen', 'email': 'kaja.m|sam-----sung\O/com' },
    { 'name': 'Karthik Gopalan', 'email': 'karthikg.g|sam-----sung\O/com' },
    { 'name': 'Kulajit Das', 'email': 'das.kulajit|sam-----sung\O/com' },
    { 'name': 'Mallikarjuna Narala', 'email': 'mallik.n|sam-----sung\O/com' },
    { 'name': 'Munukutla Subrahmanya Praveen', 'email': 'sataya.m|sam-----sung\O/com' },
    { 'name': 'Nikhil Sahni', 'email': 'nikhil.sahni|sam-----sung\O/com' },
    { 'name': 'Pavan Kumar Emani', 'email': 'pavan.e|sam-----sung\O/com' },
    { 'name': 'Prabhavathi Perumal', 'email': 'prabha.p|sam-----sung\O/com' },
    { 'name': 'Prashant Nevase', 'email': 'prashant.n|sam-----sung\O/com' },
    { 'name': 'Putturaju R', 'email': 'puttaraju.r|sam-----sung\O/com' },
    { 'name': 'Ravi Kasibhatla', 'email': 'r.kasibhatla|sam-----sung\O/com', 'username': 'kphanee' },
    { 'name': 'Shanmuga Pandi', 'email': 'shanmuga.m|sam-----sung\O/com' },
    { 'name': 'Siva Gunturi', 'email': 'siva.gunturi|sam-----sung\O/com' },
    { 'name': 'Sohan Jyoti Ghosh', 'email': 'sohan.jyoti|sam-----sung\O/com' },
    { 'name': 'Suchit Agarwal', 'email': 'a.suchit|sam-----sung\O/com' },
    { 'name': 'Sujith S S', 'email': 'sujiths.s|sam-----sung\O/com' },
    { 'name': 'Suyash Sengar', 'email': 'suyash.s|sam-----sung\O/com' },
    { 'name': 'Tanvir Rizvi', 'email': 'tanvir.rizvi|sam-----sung\O/com' },
    { 'name': 'Thanikassalam Kankayan', 'email': 'thanik.k|sam-----sung\O/com' },
    { 'name': 'Vivek Agrawal', 'email': 'vivek.s14|sam-----sung\O/com' },
    { 'name': 'Vivek Galatage', 'email': ['vivek.vg|sam-----sung\O/com'] }
]
